...
import com.datangic.requestpermissions.utils.AnnotationsUtils
...
object RequestPermissions {
     ...
     */
    var mPermissionCallbacks: PermissionCallbacks? = null


    /**
     * Callback interface to receive button clicked events of the rationale dialog
     */
    var mRationaleCallbacks: RationaleCallbacks? = null
    ...
    fun onRequestPermissionsResult(
        ...
        val grantedList = groupedPermissionsResult[PackageManager.PERMISSION_GRANTED]
                ?: emptyList()
        val deniedList = groupedPermissionsResult[PackageManager.PERMISSION_DENIED]
                ?: emptyList()
