 ...
 */
package com.datangic.requestpermissions
...
import com.datangic.requestpermissions.components.TestActivity
import com.datangic.requestpermissions.components.TestAppCompatActivity
import com.datangic.requestpermissions.components.TestFragment
import com.datangic.requestpermissions.components.TestSupportFragmentActivity
import com.datangic.requestpermissions.controllers.ActivityController
import com.datangic.requestpermissions.controllers.FragmentController
...
class RequestPermissionsTest {
    ...
    fun shouldNotHavePermissions_whenNoPermissionsGranted() {
        assertThat(RequestPermissions.hasPermissions(app, *ALL_PERMS)).isFalse()
    }
    ...
    fun shouldHavePermissions_whenAllPermissionsGranted() {
        ...
        assertThat(RequestPermissions.hasPermissions(app, *ALL_PERMS)).isTrue()
    }

    @Test
    fun shouldThrowException_whenHasPermissionsWithNullContext() {
        try {
            RequestPermissions.hasPermissions(null, *ALL_PERMS)
    ...
    fun shouldShowCorrectDialogUsingRequest_whenMissingPermissionsAndShowRationaleFromActivity() {
        ...
        val request = PermissionRequest.Builder(spyActivity)
            ...
            .build()
        RequestPermissions.requestPermissions(spyActivity, request)
    ...
    fun shouldHaveSomePermissionDenied_whenShowRationaleFromActivity() {
        ...
        assertThat(RequestPermissions.somePermissionDenied(spyActivity, *ALL_PERMS)).isTrue()
    }
    ...
    fun shouldNotHaveSomePermissionDenied_whenNotShowRationaleFromActivity() {
        ...
        assertThat(RequestPermissions.somePermissionDenied(spyActivity, *ALL_PERMS)).isFalse()
    }
    ...
    fun shouldHaveSomePermissionPermanentlyDenied_whenNotShowRationaleFromActivity() {
        ...
        assertThat(
            RequestPermissions.somePermissionPermanentlyDenied(
                spyActivity,
                ALL_PERMS.toList()
            )
        ).isTrue()
    ...
    fun shouldHavePermissionPermanentlyDenied_whenNotShowRationaleFromActivity() {
        ...
        assertThat(
            RequestPermissions.permissionPermanentlyDenied(
                spyActivity,
                READ_SMS
            )
        ).isTrue()
    ...
    fun shouldShowCorrectDialogUsingRequest_whenMissingPermissionsAndShowRationaleFromAppCompatActivity() {
        ...
        val request = PermissionRequest.Builder(spyAppCompatActivity)
            ...
            .negativeButtonText(android.R.string.cancel)
            .build()
        RequestPermissions.requestPermissions(spyAppCompatActivity, request)
    ...
    fun shouldHaveSomePermissionDenied_whenShowRationaleFromAppCompatActivity() {
        ...
        assertThat(
            RequestPermissions.somePermissionDenied(
                spyAppCompatActivity,
                *ALL_PERMS
            )
        ).isTrue()
    ...
    fun shouldShowCorrectDialogUsingRequest_whenMissingPermissionsAndShowRationaleFromFragment() {
        ...
        val request = PermissionRequest.Builder(spyFragment.context)
            ...
            .build()
        RequestPermissions.requestPermissions(spyFragment, request)
